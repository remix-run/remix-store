...
const hydrogenWithReactRouter715 = {
  ...hydrogen,
  async reactRouterConfig(args) {
    ...
    // `future.unstable_subResourceIntegrity` flag. React Router 7.15 stabilized
    // this into top-level `subResourceIntegrity`, so strip the deprecated flag
    // while preserving the rest of the Hydrogen preset.
...
export default {
  presets: [hydrogenWithReactRouter715],
  appDirectory: "app",
  buildDirectory: "dist",
  ssr: true,
} satisfies Config;
