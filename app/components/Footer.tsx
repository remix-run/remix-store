  ...
  return (
    <Suspense>
      <Await resolve={footerPromise}>
        {(footer) => (
          <footer className="inline-flex bg-neutral-200 dark:bg-neutral-800 justify-center gap-4 md:gap-20 lg:gap-28 xl:gap-32 border-t-[1px] border-neutral-400 border-opacity-20 w-full">
...
function FooterMenu({
  ...
  return (
    <nav
      className="flex-col py-10 justify-start items-start gap-y-2"
      role="navigation"
    >
      <h3 className="dark-text-white justify-start py-1 text-xs font-bold font-body tracking-tight">
        {menu?.title}
      </h3>
...
function CopyrightContent() {
  return (
    <div className="flex justify-center text-neutral-400 text-xs pb-6 bg-neutral-200 dark:bg-neutral-800">
