...
export type HeaderQuery = {
  shop: Pick<StorefrontAPI.Shop, 'id' | 'name' | 'description'> & {
    storeWideSale?: StorefrontAPI.Maybe<{
      reference?: StorefrontAPI.Maybe<{
        ...
        description?: StorefrontAPI.Maybe<
          Pick<StorefrontAPI.MetaobjectField, 'value'>
        >;
        endDateTime?: StorefrontAPI.Maybe<
          Pick<StorefrontAPI.MetaobjectField, 'value'>
        >;
      }>;
    }>;
                        ...
                        | ({__typename: 'MediaImage'} & Pick<
                          ...
                          > & {
                              presentation?: StorefrontAPI.Maybe<
                                Pick<
                                  StorefrontAPI.MediaPresentation,
                                  'id' | 'asJson'
                                >
                              >;
                              image?: StorefrontAPI.Maybe<
...
> & {
  ...
  technicalDescription?: StorefrontAPI.Maybe<
    Pick<StorefrontAPI.Metafield, 'value'>
  >;
  subscribeIfBackInStock?: StorefrontAPI.Maybe<
    Pick<StorefrontAPI.Metafield, 'value'>
  >;
};
...
export type ProductSidebarMenuQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;

export type ProductSidebarMenuQuery = {
  menu?: StorefrontAPI.Maybe<
    Pick<StorefrontAPI.Menu, 'id' | 'title'> & {
      items: Array<
        Pick<
...
interface GeneratedQueryTypes {
  ...
  '#graphql\n  query ProductSidebarMenu(\n    $country: CountryCode\n    $language: LanguageCode\n  ) @inContext(language: $language, country: $country) {\n    menu(handle: "product-sidebar-menu") {\n      ...Menu\n    }\n  }\n  #graphql\n  fragment MenuItem on MenuItem {\n    id\n    resourceId\n    tags\n    title\n    type\n    url\n  }\n  fragment ChildMenuItem on MenuItem {\n    ...MenuItem\n  }\n  fragment ParentMenuItem on MenuItem {\n    ...MenuItem\n    items {\n      ...ChildMenuItem\n    }\n  }\n  fragment Menu on Menu {\n    id\n    title\n    items {\n      ...ParentMenuItem\n    }\n  }\n\n': {
    return: ProductSidebarMenuQuery;
    variables: ProductSidebarMenuQueryVariables;
  };
